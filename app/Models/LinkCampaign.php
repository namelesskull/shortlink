...
class LinkCampaign extends BaseModel
{
    const MODEL_TYPE = 'linkCampaign';

    use HasFactory, SoftDeletes, HasShortUrlAttribute, BelongsToWorkspace;
    ...
    {
        return $this->belongsToMany(Link::class, 'link_campaign_link')
            ->inRandomOrder()
            ->limit(1);
    }
    ...
    {
        return $this->hasManyThrough(LinkeableClick::class, Link::class);
    }
