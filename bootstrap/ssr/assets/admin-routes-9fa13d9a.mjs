...
const IconList = React.lazy(() => import("./icon-list-6739db40.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-b234e4eb.mjs"));
...
//# sourceMappingURL=admin-routes-9fa13d9a.mjs.map
