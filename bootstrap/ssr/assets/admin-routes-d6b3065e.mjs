...
const IconList = React.lazy(() => import("./icon-list-9cc99c2f.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-7c87fa17.mjs"));
...
//# sourceMappingURL=admin-routes-d6b3065e.mjs.map
