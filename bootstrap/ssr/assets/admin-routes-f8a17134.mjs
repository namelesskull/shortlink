...
const IconList = React.lazy(() => import("./icon-list-db480abd.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-99eb2389.mjs"));
...
//# sourceMappingURL=admin-routes-f8a17134.mjs.map
